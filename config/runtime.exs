...
#
#     PHX_SERVER=true bin/ops_platform start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :ops_platform, OpsPlatformWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :ops_platform, OpsPlatform.Repo,
    # ssl: true,
    url: database_url,
  ...
  config :ops_platform, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  config :ops_platform, OpsPlatformWeb.Endpoint,
    ...
    check_origin: ["http://localhost:4000", "http://127.0.0.1:4000", "http://100.125.46.74:4000", "https://100.125.46.74"]
