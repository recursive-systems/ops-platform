defmodule OpsPlatformWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: OpsPlatformWeb.Gettext
  ...
  ## Examples
      ...
      <.modal id="my-modal" show on_cancel={JS.push("close")}>
        <p>Modal content</p>
      </.modal>
  """
  attr :id, :string, required: true
        ...
        <div class="flex min-h-full items-center justify-center">
          <div class="w-full max-w-lg p-4 sm:p-6 lg:py-8">
            <.focus_wrap
              ...
              class="relative bg-base-100 rounded-2xl shadow-xl p-8 ring-1 ring-base-300"
            >
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(OpsPlatformWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(OpsPlatformWeb.Gettext, "errors", msg, opts)
    end
  end
